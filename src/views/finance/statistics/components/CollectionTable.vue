...
<script lang="ts">
  ...
  import { exportExcelCollection, getStatisticsCollectList } from '/@/api/finance/statistics'
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      async function aoaToExcel() {
        ...
        const res = await exportExcelCollection(params)
        downloadByData(res.data, '收款汇总统计.xlsx')
