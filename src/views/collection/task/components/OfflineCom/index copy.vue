...
<script lang="tsx">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const iframeUrl = ref(`https://admin.gsrental.cn/newAdmin/assets/index.d868d633b.js/iframe=true#/zzy?path=CollectionPage/CollectionTaskNewPage&iframe=true&newToken=${newToken}`)
      const lockCount = ref({
        curLockCount: 0,
        clientLockMax: 0,
      })
