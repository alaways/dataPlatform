...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const iframeUrl = ref(`https://admin.gsrental.cn/newAdmin/assets/index.d868d633b.js/iframe=true#/zzy?path=Collection/CollectionTask&iframe=true&newToken=${newToken}`)
      ...
      const getRankCount = async () => {
        ...
        const res = await getCollectionRankCount({ dataSources : 'xx'})
