...
import { fenToYuan, formatDecimal, formatNumber, handleImgAfter } from '/@/utils/tool'
...
export const formSchema: FormSchema[] = [
  ...
  {
    labelWidth: 190,
    field: 'commBusinessLoanSettleRate',
    label: '周付业务标签货款结算比例',
    component: 'InputNumber',
    defaultValue: 0,
    // required: true,
...
export const confirmColumns: FormSchema[] = [
  {
    title: '商家编号',
    dataIndex: 'merchantCode',
  },
  ...
  },
  {
    ...
    dataIndex: 'amount',
    customRender: ({ record }) => {
      return fenToYuan(record?.amount)
    },
  },
  {
    title: '申请时间',
    ...
    customRender: ({ record }) => {
      return record?.updateTime || record?.createTime
    },
  },
  {
    title: '确认充值时间',
  ...
  },
  {
    ...
    dataIndex: 'status',
    customRender: ({ record }) => {
      return statusObj[record?.status] || '-'
    },
  },
]
